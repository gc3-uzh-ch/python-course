...
\begin{frame}[fragile]
  ...
  Expressions can be entered at the Python shell prompt \texttt{>>>}; they are
...
\begin{frame}[fragile]
  ...
  \+ 
  Not all Python constructs return value. 
...
\begin{frame}[fragile,fragile,fragile]
  ...
  \+
  \includegraphics[height=0.35\textheight]{python_assignment01}
